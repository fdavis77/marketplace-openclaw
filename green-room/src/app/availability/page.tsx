...
export default async function AvailabilityPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      <h1 className="font-display text-3xl font-extrabold">Availability</h1>
      ...
      <details className="mt-8 rounded-card border border-border bg-surface p-4">
        <summary className="cursor-pointer font-display font-semibold">+ Block dates</summary>
      ...
      {past.length ? (
        <details className="mt-8">
          ...
          <div className="mt-3 flex flex-col gap-2">
            {past.map((b) => (
              <div key={b.id} className="flex items-center justify-between rounded-card border border-border bg-muted-surface p-3 text-sm text-muted">
